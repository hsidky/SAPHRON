...
namespace Ensembles
{
	...
	template<typename T>
	void WangLandauDOSEnsemble<T>::Iterate()
	{
	...
	template<typename T>
	double WangLandauDOSEnsemble<T>::AcceptanceProbability(double prevH, double currH)
	{
	...
	template class WangLandauDOSEnsemble<Site>;
}
